...
export function buildVariables(params: BuildVariablesParams): Record<string, string> {
	...
	const variables: Record<string, string> = {
		...
		'{{time_on_page}}': formatTimeOnPage(params.timeOnPage ?? 0),
		'{{tab_id}}': params.tabId !== undefined ? params.tabId.toString() : '',
		'{{window_id}}': params.windowId !== undefined ? params.windowId.toString() : '',
	};
