...
// Default denylist of domains excluded from auto-save.
export const DEFAULT_DOMAIN_FILTER = [
	'x.com',
	'youtube.com',
	'facebook.com',
	'instagram.com',
...
// Domain filter matching (denylist).
// - Empty list means all domains are allowed (no filter).
// - A non-empty list denies any URL whose hostname matches one of the domains.
// - Subdomains are matched too (e.g. "example.com" also matches "www.example.com").
